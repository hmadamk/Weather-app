...
function onSuccess(position) {
    ...
    api = `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&units=metric&appid=8881e81033174eb129cef90b7afa9adb`;
    fetchData()
}
...
function requestApi(city) {
    api = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=8881e81033174eb129cef90b7afa9adb`;
    fetchData()
}
function fetchData() {
